...
st.markdown("""
<div style="background: linear-gradient(135deg, #B3E5FC 0%, #E1F5FE 50%, #F3E5F5 100%); 
...
# Beautiful footer
st.markdown("""
<div style="text-align: center; padding: 2rem; background: linear-gradient(135deg, #B3E5FC 0%, #E1F5FE 50%, #F3E5F5 100%); 
